...
def clean_accounting_data(df):
    ...
    id_cols = ['expense_id', 'related_entity']
    date_cols = ['date']
    cat_cols = ['expense_type', 'receipt_available', 'cost_center']

    print(f"--- Rapport d'Audit pour Accounting ---")
    ...
    # --- NETTOYAGE EFFECTIF ---
    # On filtre les IDs
    df_clean = df[df['expense_id'] != 'BADID'].copy()
